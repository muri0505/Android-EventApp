...
/*
    ...
    set default to search event fragment, pass input event name to event information fragment
 */
public class ControlEvent extends AppCompatActivity implements FragmentSearchEvent.FragmentSearchEventListener{
